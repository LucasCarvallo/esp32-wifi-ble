...
constexpr unsigned long MONITOR_SWEEP_INTERVAL_MS = 15000; // Intervalo entre sweeps monitor (ms)
constexpr unsigned long MONITOR_DWELL_MS = 500;            // Tiempo por canal en monitor (ms)
constexpr unsigned long MONITOR_DEDUP_WINDOW_MS = 8000;    // Ventana de deduplicación local (ms)
constexpr size_t MONITOR_MAX_CLIENTS = 20;                 // Máx clientes en tabla interna
